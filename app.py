...
3. 자료에 답변이 없으면 "적절한 답변을 찾지 못했습니다. 관리자에게 문의해 주세요. (소통폰 : 010-2629-8002)\n\n태그: #기타 #문의사항"라고만 말하세요.
4. 답변은 친절하고 명확하게 한국어로 작성하세요.
5. 중요한 수치(날짜, 시간, 벌점 등)는 정확히 그대로 인용하세요.
6. 답변의 가장 마지막 줄에는 한 줄 띄운 후, 답변 내용 및 카테고리와 연관된 해시태그(연관 키워드)를 아래 형식으로 3개 이하로 작성하세요. (자료의 카테고리는 반드시 첫 번째 태그로 포함해야 합니다)
형식 예시:
태그: #카테고리명 #키워드1 #키워드2"""
